...
public class ABCustomerDetailsActivity extends AppCompatActivity {
    ...
    String networkStatus = "", message, activity_id, job_id,subgroup_id,group_id,group_detail_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            Log.w(TAG, "UKEYYYYYDESccccccccuutc" + UKEY_DESC);
       ...
       int ieeee = sharedPreferences1.getInt("formtypeval", 0);
       Log.w(TAG,"ieee"+ieeee);
